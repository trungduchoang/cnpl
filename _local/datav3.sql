...
DROP TABLE IF EXISTS `attestation_options`;
CREATE TABLE `attestation_options` (
...
-- ----------------------------
-- Records of attestation_options
-- ----------------------------
-- BEGIN;
-- INSERT INTO `attestation_options` (`id`, `origin`, `challenge`) VALUES (1, 'https:plate.id', 'b0ce2588f286ed9ec88fd2effc8854538c25fb09');
-- INSERT INTO `attestation_options` (`id`, `origin`, `challenge`) VALUES (2, 'https:plate.id', '36fe9750ff6da2050fab5ef0ca2b7be9618bcacd');
-- INSERT INTO `attestation_options` (`id`, `origin`, `challenge`) VALUES (3, 'https:plate.id', '9b45677210b4ab637df31a0f7c476a1277a59641');
-- INSERT INTO `attestation_options` (`id`, `origin`, `challenge`) VALUES (4, 'https:plate.id', 'b41c87a7a4556a0cb371a7a5120cd1fbf59b0659');
-- INSERT INTO `attestation_options` (`id`, `origin`, `challenge`) VALUES (5, 'https:plate.id', '163e962f0b0400c132640ee72984be79cb968d7d');
-- INSERT INTO `attestation_options` (`id`, `origin`, `challenge`) VALUES (6, 'https:plate.id', '40097a9b451131822b06302cb1dcd83c890921ab');
-- INSERT INTO `attestation_options` (`id`, `origin`, `challenge`) VALUES (7, 'https:plate.id', '04d10b3108b8bbf04f1c71fff93bda8304cad0cf');
-- INSERT INTO `attestation_options` (`id`, `origin`, `challenge`) VALUES (8, 'https:plate.id', '492c115406541286b191154c75ae3e24f47da4d6');
-- COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `credentials` (`credential_id`, `cookie`, `oauth_username`, `project_id`, `pem`) VALUES ('AUVoLzJN54eoFv89O3Q8xwOkQGaOA_yc7hU9oFXCLmKsJomDlFK-30OtWu0zNjK3pW7YVZ5F69Vp', '', '0wRIeXHTtj', '1111', '6c0a898c-c184-4b19-ae40-fdde61913f96');
COMMIT;
